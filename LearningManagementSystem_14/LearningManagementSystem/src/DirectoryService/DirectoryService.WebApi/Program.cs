...
//
// Автоматически регистрируем все валидаторы (IValidator<T>) из сборки
// DirectoryService.UseCases (CreateStudentCommandValidator, UpdateStudentCommandValidator,
// ChangeStudentClassCommandValidator, DeleteStudentCommandValidator, GetStudentByIdQueryValidator).
// Обработчики команд/запросов запрашивают нужный IValidator<TCommand> через DI сами.
